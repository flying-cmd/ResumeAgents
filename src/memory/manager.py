...
# Manager all memory-related operations
class MemoryManager:
    ...
    # Why use hash?
    # Because the original content may be long or contain special characters.
    # For example, this is not a good filename: I have experience with Python, React, SQL, .NET, Azure...
    # Instead, the system converts it to a hash: 3f7a1d9b8c... Then it can safely use it in a filename.
...
# Check memory first
# ↓
# If found, reuse old optimized content
# ↓
# If not found, call LLM
# ↓
# Save new result to memory
# ↓
